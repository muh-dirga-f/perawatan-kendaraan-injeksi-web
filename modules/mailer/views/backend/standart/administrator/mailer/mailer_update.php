...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class=""><a  href="<?= site_url('administrator/mailer'); ?>">Mailer</a></li>
            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/mailer/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_mailer', 
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/mailer';
            }
          });
