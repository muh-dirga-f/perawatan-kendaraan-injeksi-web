...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class=""><a href="<?= site_url('administrator/email'); ?>">Email</a></li>
      ...
      <div class="box box-warning">
        <div class="box-body ">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <?= form_open(base_url('administrator/email/edit_save/' . $this->uri->segment(4)), [
              'name'    => 'form_email',
  ...
  $(document).ready(function() {
    ...
    $('#btn_cancel').click(function() {
      swal({
        ...
        function(isConfirm) {
          if (isConfirm) {
            window.location.href = BASE_URL + 'administrator/email';
          }
        });
