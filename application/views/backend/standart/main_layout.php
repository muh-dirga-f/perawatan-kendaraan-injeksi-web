...
<body class="sidebar-mini skin-black fixed web-body">
  <div class="wrapper" id="app">
    ...
    <header class="main-header">
      ...
      <span class="logo">
        <span class="logo-mini"><b><img src="<?= base_url($logo) ?>" height="40px"></b></span>
        <span class="logo-lg text-white"><b><img src="<?= base_url($logo) ?>" height="40px"> Admin Panel</b></span>
      </span>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  <li class="user-header" style="background-color: #337ab7 !important;">
                  ...
                  <li class="user-footer" style="background-color: #d9edf7 !important;">
                    <div class="pull-left">
